...
const char* MQTTPacket_getName(U64 packetid)
{
...
int MQTTStringFormat_publish(char* strbuf, int strbuflen, unsigned char dup, int qos, unsigned char retained,
		U64 packetid, MQTTString topicName, unsigned char* payload, int payloadlen)
{
...
int MQTTStringFormat_ack(char* strbuf, int strbuflen, unsigned char packettype, unsigned char dup, U64 packetid)
{
...
int MQTTStringFormat_subscribe(char* strbuf, int strbuflen, unsigned char dup, U64 packetid, int count,
...
int MQTTStringFormat_suback(char* strbuf, int strbuflen, U64 packetid, int count, int* grantedQoSs)
{
	return snprintf(strbuf, strbuflen,
...
int MQTTStringFormat_unsubscribe(char* strbuf, int strbuflen, unsigned char dup, U64 packetid,
